...
```{r}
mdbs <- factor(c("Alice Weidel", "Robert Habeck", "Julia Kloeckner", "Andreas Scheuer", "Bernd Riexinger", "Katarina Barley"), 
        levels = c("AfD", "Buendnis90/Die Gruenen", "CDU", "CSU", "Die Linke", "SPD"))
levels(mdbs)
typeof(mdbs)
```
