...
* `read_csv2("file.csv")` reads semi-colon delimited files and treats commas as           
...
Download the "training files" from my GitHub (<https://github.com/fellennert/bdawR2020>). If you're not on GitHub: just download the entire repo as .zip file, unpack it, and delete the stuff you do not need. If you are on GitHub: fork it.

Read them in using the right functions. Specify the parameters properly. Hints can be found in `hints.md`.
